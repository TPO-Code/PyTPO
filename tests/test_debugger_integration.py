...
from barley_ide.ui.debugger.breakpoint_store import DebuggerBreakpointStore
from barley_ide.ui.debugger.backend import DebugLaunchKind, DebugLaunchRequest, ExecutionState
from barley_ide.ui.debugger.debugpy_backend import DebugpyPythonDebuggerBackend
from barley_ide.ui.debugger.lldb_dap_backend import LldbDapDebuggerBackend
from barley_ide.ui.debugger.python_backend import BdbPythonDebuggerBackend, DEBUGGER_HARNESS_CODE, normalize_breakpoint_map
from barley_ide.ui.debugger.python_backend import PythonDebuggerBackend
from barley_ide.ui.debugger.session_widget import DebuggerSessionWidget
from barley_ide.ui.debugger.terminal_bridge import DebugTerminalBridge
from barley_ide.ui.debugger_support import debugger_breakpoints_supported_for_path
...
class LldbDapBackendUnitTests(unittest.TestCase):
    def test_adapter_path_accepts_versioned_lldb_vscode_binary(self) -> None:
        with mock.patch.object(LldbDapDebuggerBackend, "_adapter_candidates", return_value=("lldb-dap", "lldb-vscode-14")):
            with mock.patch("barley_ide.ui.debugger.lldb_dap_backend.shutil.which") as which_mock:
