...
from pytpo.services.syntax_highlighting_config import is_valid_syntax_color, normalize_syntax_highlighting_settings
from pytpo.settings_models import SettingsScope
from pytpo.ui.theme_runtime import apply_settings_color_swatch_size
