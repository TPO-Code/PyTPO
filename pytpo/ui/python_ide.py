...
from pytpo.ai.inline_controller import InlineSuggestionController
from pytpo.ai.openai_compatible_client import OpenAICompatibleClient
from pytpo.ai.settings_schema import normalize_ai_settings
from pytpo.core.keybindings import get_action_sequence, normalize_keybindings
from pytpo.formatting import CodeFormattingRegistry, FormatRequest
from pytpo.formatting.providers import (
...
from pytpo.services.file_open_classifier import FileOpenKind, classify_file_for_open
from pytpo.services.project_policy_service import ProjectPolicyService
from pytpo.storage_paths import ide_config_dir, ide_no_project_workspace_dir, migrate_legacy_ide_storage

from pytpo.ui.console_run_manager import ConsoleRunManager
from pytpo.ui.completion_manager import CompletionManager
from pytpo.ui.controllers import (
    ActionRegistry,
...
from pytpo.ui.dialogs.terminal_commands_dialog import TerminalCommandsDialog
from pytpo.ui.dialogs.workspace_slot_name_dialog import WorkspaceSlotNameDialog
from pytpo.ui.settings_dialog import SettingsDialog as ScopedSettingsDialog, create_default_settings_schema
from pytpo.ui.syntax_highlighting_runtime import configure_syntax_highlighting_runtime

from pytpo.ui.editor_workspace import EditorTabs, EditorWidget, EditorWorkspace
from pytpo.ui.lint_manager import LintManager
from pytpo.ui.spellcheck_manager import SpellcheckManager
from pytpo.ui.debugger import DebuggerDockWidget
from pytpo.ui.widgets.code_editor import CodeEditor
from pytpo.ui.widgets.codex_agent_dock import CodexAgentDockWidget
...
from pytpo.ui.widgets.tdoc_document_widget import TDocDocumentWidget
from pytpo.ui.widgets.unified_diff_editor import UnifiedDiffEditor
from pytpo.ui.widgets.usages_panel import UsagesPanel
from pytpo.ui.widgets.welcome_screen import WelcomeScreenWidget
...
class PythonIDE(Window):
    ...
    def open_check_for_updates_dialog(self) -> None:
        from pytpo.services.update_service import UpdateService
        from pytpo.ui.dialogs.check_for_updates_dialog import CheckForUpdatesDialog
    ...
    def show_about_dialog(self) -> None:
        from pytpo.ui.dialogs.about_dialog import AboutDialog
