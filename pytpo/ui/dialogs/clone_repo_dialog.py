...
from pytpo.git.git_clone_service import (
    GitCloneError,
    GitCloneService,
    ParsedRepoUrl,
    parse_repo_url,
...
from pytpo.git.github_client import GitHubClient, GitHubClientError, GitHubRepo
from pytpo.settings_manager import SettingsManager
from TPOPyside.dialogs.custom_dialog import DialogWindow
from pytpo.ui.dialogs.file_dialog_bridge import get_existing_directory
