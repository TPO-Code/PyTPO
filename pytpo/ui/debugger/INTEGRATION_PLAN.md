...
- IDE-owned debugger code under `pytpo/ui/debugger/`
...
- module entry resolution now understands common `pytpo/` package layouts, and live debugpy coverage includes a package/module launch case for that shape
...
- `pytpo/ui/debugger/editor_adapter.py`
- `pytpo/ui/debugger/lldb_dap_backend.py`
- `pytpo/ui/debugger/python_backend.py`
- `pytpo/ui/debugger/session_context.py`
