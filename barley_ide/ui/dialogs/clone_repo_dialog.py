...
from barley_ide.git.git_clone_service import (
    GitCloneError,
    GitCloneService,
    ParsedRepoUrl,
    parse_repo_url,
...
from barley_ide.git.github_client import GitHubClient, GitHubClientError, GitHubRepo
from barley_ide.settings_manager import SettingsManager
from TPOPyside.dialogs.custom_dialog import DialogWindow
from barley_ide.ui.dialogs.file_dialog_bridge import get_existing_directory
