...
class UpdateService:
    ...
    def current_version(self) -> str:
        for package_name in ("barley_ide", "barley-ide", "pytpo"):
            try:
                value = importlib_metadata.version(package_name)
    ...
    def _require_repo_root(self) -> str:
        ...
        try:
            ...
            raise UpdateServiceError("Updater requires a Git checkout of Barley.", kind="not_git_repo") from None
