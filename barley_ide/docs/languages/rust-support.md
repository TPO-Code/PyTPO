...
Barley uses `rust-analyzer` for language intelligence, Cargo for build/run workflows, and an LLDB DAP adapter for Rust debugging.
...
For each file, Barley walks upward for `Cargo.toml`:
...
Recommended screenshot: `barley_ide/docs/assets/screenshots/11-rust-cargo-configuration.png`
