...
Recommended screenshot: `barley_ide/docs/assets/screenshots/01-welcome-screen.png`

## 2. Open a project

1. Use `File -> Open Project...`.
2. Select your project folder.
3. Barley loads project settings from `.tide/project.json`.

Recommended screenshot: `barley_ide/docs/assets/screenshots/02-open-project-dialog.png`
...
Recommended screenshot: `barley_ide/docs/assets/screenshots/03-settings-dialog-overview.png`
