...
- each slot uses an assigned key, and Barley keeps load/save paired as `Ctrl+key` and `Ctrl+Shift+key`
...
Recommended screenshot: `barley_ide/docs/assets/screenshots/15-keybindings-settings-page.png`
