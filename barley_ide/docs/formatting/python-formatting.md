...
Barley formats Python files with Ruff over stdin/stdout.

## Config discovery order

For each file, Barley searches upward for:
...
If no valid Ruff config is found, Barley opens `No ruff.toml found` with:
...
Recommended screenshot: `barley_ide/docs/assets/screenshots/12-format-missing-ruff-config-dialog.png`
