...
Barley runs commands in managed terminal tabs with per-target session tracking.
...
3. Else Barley runs the current file context.
...
Recommended screenshot: `barley_ide/docs/assets/screenshots/07-terminal-run-output.png`
